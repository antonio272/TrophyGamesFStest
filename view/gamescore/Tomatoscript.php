...
<?php
    if( isset($_SESSION["user_id"]) 
        ...
        echo'
        <div id="youwin">
        <form  id="result" method="post" action="' .BASE_PATH. 'userplays/subscribe">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var lat = <?php echo $game["lat1"]; ?>, lng = <?php echo $game["lon1"]; ?>;
        var lat2 = <?php echo $game["lat2"]; ?>, lng2 = <?php echo $game["lon2"]; ?>;
        var v1 = <?php echo $game["vel1"]; ?>;
        var v2 = <?php echo $game["vel2"]; ?>;
        var lat3 = lat2;
        var lng3 = lng2;
